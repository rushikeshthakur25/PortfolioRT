        ...
        <div className="mx-auto w-full max-w-7xl ">
            ...
            <div className="mx-auto w-full max-w-7xl">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl  mb-8 text-cyan-200 font-mono "><samp className='text-gray-200 text-center  '>Hi,I'M</samp><br /><samp className='font-bold text-4xl font-sans'>R</samp>ushikesh Thakur</h2>
                    <p className="text-lg text-gray-700">I am an experienced <samp className='text-emerald-600 font-mono'>Full Stack Developer</samp> and <samp className=' text-orange-700 font-mono'>Cyber Security Analyst</samp >. Proficient in JavaScript, React.js, Next.js, Bootstrap, and Tailwind UI. <samp className=' text-green-900 font-mono'>Expert in bug bounty hunting</samp>, VAPT, and tools like <samp className=' text-cyan-700 font-mono'>Burp Suite, Nmap, and Wireshark</samp>. Skilled in managing DLP, proxies, and WAF, with <samp className=' text-fuchsia-700 font-mono'>a proven reduction in vulnerabilities</samp>. Passionate about secure and innovative tech projects. Let's connect!</p>
                </div>

                <section className="py-16">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl text-center  text-orange-500 mb-8"><samp className='font-bold text-4xl font-serif'>W</samp>hat I Do?</h2>
