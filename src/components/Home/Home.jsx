        ...
        <div className="mx-auto w-full max-w-7xl ">
            ...
            <div className="mx-auto w-full max-w-7xl">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold mb-8 text-orange-500 "><samp className='text-white text-center '>Hi,I'm</samp><br /> Rushikesh Thakur</h2>
                ...
                <section className="py-16">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-gray-800 rounded-lg shadow-md flex flex-col items-center justify-center p-6 transform hover:-translate-y-1 transition-transform duration-300">
